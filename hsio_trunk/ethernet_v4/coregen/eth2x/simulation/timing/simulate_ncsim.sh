...
ncelab -notimingchecks -NOWARN CSINFI -NOWARN CUVWSI -NOWARN NTCNNC -NOWARN CUVWSP -NOWARN NCCDELW -loadpli1 swiftpli:swift_boot -access +rw -sdf_cmd_file sdf.cmd work.testbench:behavioral
