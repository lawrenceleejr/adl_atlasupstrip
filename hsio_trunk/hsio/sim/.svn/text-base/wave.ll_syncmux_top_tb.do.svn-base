...
add wave -noupdate -format Logic -radix hexadecimal /ll_syncmux_top_tb/r_src_rdy
add wave -noupdate -format Logic -radix hexadecimal /ll_syncmux_top_tb/r_sof
add wave -noupdate -format Logic -radix hexadecimal /ll_syncmux_top_tb/r_eof
add wave -noupdate -format Logic -radix hexadecimal /ll_syncmux_top_tb/r_dst_rdy
add wave -noupdate -format Literal -radix hexadecimal /ll_syncmux_top_tb/r_data
add wave -noupdate -format Literal -radix hexadecimal /ll_syncmux_top_tb/r_data_len
...
add wave -noupdate -format Literal -radix hexadecimal -expand /ll_syncmux_top_tb/s_sof
...
add wave -noupdate -format Literal -radix unsigned /ll_syncmux_top_tb/selected_stream
add wave -noupdate -format Literal -radix unsigned /ll_syncmux_top_tb/selected_stream
add wave -noupdate -format Literal -radix unsigned /ll_syncmux_top_tb/udut/sel_mux16
add wave -noupdate -format Literal -radix unsigned /ll_syncmux_top_tb/udut/sel_mux4
add wave -noupdate -format Literal /ll_syncmux_top_tb/udut/q_dst_rdy
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {19254079 ps} 0}
